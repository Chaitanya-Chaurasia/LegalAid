...
function Login(){
    return(
        <Center w={'100%'} h={'90vh'}>
            <Flex w={'400px'} h={'500px'} backgroundColor={'#E0E0E0'} borderRadius={'20px'} alignItems={'center'} flexDir={'column'}>
                ...
                <Center flex={1} width={'100%'} gap={'50px'} flexDir={'column'}>
                    ...
                    <Center flexDir={'column'} gap={'20px'}>
                        <Button colorScheme='blackAlpha' p={'0 50px'}>Login</Button>
                        <Button colorScheme='whiteAlpha' textColor={'#101010'}><Image src={google} h={'30px'} pr={'10px'}/>Log-in with Google</Button>
                    </Center>
                </Center>
            </Flex>
        </Center>
